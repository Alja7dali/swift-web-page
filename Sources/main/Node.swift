...
//   /// Represents an element node with a tag name, an array of attributes,
//   /// and an array of child nodes.
//   indirect case element(String, Array<Attribute>, Node)

//   /// Represents an array of nodes.
//   case fragment(Array<Node>)

//   /// An unsafe escape hatch: represents raw text that should not be escaped
//   /// by a renderer.
//   case raw(String)
